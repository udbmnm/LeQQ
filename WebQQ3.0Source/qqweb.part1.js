...
function(a) {
    ...
    this.setTimingRpt = function(a, b, c, d) {
        ...
        if ((f = f ? f: window.performance) && (e = f.timing)) {
            ...
            for (var d = e[g[0]], A = 1, y = g.length; A < y; A++) f = (f = e[g[A]]) ? f - d: 0,
            f > 0 && n.push(A + "=" + f);
...
function(a) {
    ...
    var y = function(a, e, d, h, k) {
        if (f(d)) d = c.getFileInfoByFile(a).position;
        e.items.splice(d, 1);
        if (a.t === g.FOLDER) {
            if (h && a.items && a.items.length) for (h = a.items.length - 1; h >= 0; h--) y(a.items[h], a, h, !0, k);
            delete a.pid
        }
        j[a.t][a.id] && l[a.t]--;
        j[a.t][a.id] = null;
    ...
    this.deleteFile = function(a, b, c, e, d, k) {
        ...
        var q, z = !1;
        if (f(b)) {
            if (a = this.getFileInfoByFile(a)) z = a.file,
            q = a.parent,
            c = a.position
        } else if (q = this.getFolderById(b), f(c)) {
            if (a = this.getFileInfoByFile(a, q, !1)) z = a.file,
            q = a.parent,
            c = a.position
        } else z = q.items[c];
        if (q && z) {
...
r?b.notifyObservers(c,"FileProcessing",a):(r=!0,e={objs:a,pid:e,ti:d<0?0:d},k=k||{},k.noProcessStatus=f(k.noProcessStatus)?q:k.noProcessStatus,k={data:e,arguments:k},k.onSuccess=h||H.onAddFileSuccess,k.onError=H.onAddFileError,k.onTimeout=H.onAddFileTimeout,k.action="create",k.method="POST",C(k),I(a,"create"))},G=function(a,e,d,h,k){if(!k&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var q=[],z;for(z in a){var m=a[z];if(!k&&Q(m,!0))return;q.push({t:m.t,id:m.id})}e={did:e,objs:q};h=h||{};h.noProcessStatus=
f(h.noProcessStatus)?k:h.noProcessStatus;h={data:e,arguments:h};h.onSuccess=d||H.onDeleteFileSuccess;h.action="remove";h.method="POST";C(h);I(a,"del")}},K=function(a,e,d,h,k,q,z,m){if(!m&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var g=[],n;for(n in a){var y=a[n];if(!m&&Q(y,!0))return;g.push({t:y.t,id:y.id})}z=z||{};z.noProcessStatus=f(z.noProcessStatus)?m:z.noProcessStatus;z={arguments:z};if(e==h)z.action="order",z.data={did:h,from:k,to:d,count:g.length};else if(z.action="move",z.data=
{objs:g,did:h,tid:e,ti:d<0?0:d},e===5)z.data.limit=5,z.data.ofd=h;z.onSuccess=q||H.onMoveFileSuccess;z.method="POST";C(z);I(a,"move")}},P=this.sendUpdateFiles=function(a,e,d,h,k){if(!k&&r)b.notifyObservers(c,"FileProcessing",a);else{r=!0;var z=[],q;for(q in a){var m=a[q];if(!k&&Q(m,!0))return;var g={t:m.t,id:m.id,n:m.n};if(!f(m.n))g.n=m.n,g.on=m.on;z.push(g)}e={did:e,objs:z};h=h||{};h.noProcessStatus=f(h.noProcessStatus)?k:h.noProcessStatus;h={data:e,arguments:h};h.onSuccess=d||H.onUpdateFileSuccess;
...
r=!1;e.arguments.noProcessStatus||b.notifyObservers(c,"FileOperateTimeout",e.arguments);var d=e.arguments;delete e.arguments;alloy.rpcService.sendFileErrorReport({request:d,response:e})},onAddFileSuccess:function(e){r=!1;if(e.retcode==0&&e.result&&e.result.code==0){var d=e.result.objs||[],e=e.arguments,h=f(e.position)?e.parent.items.length:e.position,k;for(k in d){var z=d[k];if(z.t==g.FILE)z.upload=1;A(z,e.parent,h);h+=1;a.isFunction(e.callback)&&e.callback(z)}}else a.error("AddFileFail"),e.arguments.noProcessStatus||
b.notifyObservers(c,"AddFileFail",e),e.arguments.fileList&&e.arguments.fileList[0]&&(z=e.arguments.fileList[0],z.t==g.FOLDER?alloy.util.report2m(151383):z.t==g.APP?alloy.util.report2m(151387):(z.t==g.BUDDY||z.t==g.GROUP)&&alloy.util.report2m(151391)),d=e.arguments,delete e.arguments,alloy.rpcService.sendFileErrorReport({request:d,response:e})},onDeleteFileSuccess:function(e){r=!1;if(e.retcode==0&&e.result&&e.result.code==0){var e=e.arguments,d=e.fileList,f;for(f in d){var h=d[f];Q(h,!1);y(h,e.parent,
...
L=function(){m();j={};j[g.FOLDER]={};j[g.FILE]={};j[g.APP]={};j[g.BUDDY]={};j[g.GROUP]={};l={};l[g.FOLDER]=0;l[g.FILE]=0;l[g.APP]=0;l[g.BUDDY]=0;l[g.GROUP]=0;e();h()||z();t=!0;b.notifyObservers(c,"FileSystemReady");b.notifyObservers(alloy.portal,"UACReady")},S=[],W=function(){},M=function(b){r=!1;if(!(b.retcode==0&&b.result&&b.result.code==0)){a.error("AddFileFail");var e=b.arguments;delete b.arguments;alloy.rpcService.sendFileErrorReport({request:e,response:b})}},U=function(a){S.push(a)},X=function(){for(var a;a=
S.shift();)setTimeout(a,500)},z=function(){var b=alloy.config.getSetupAppList(),e=alloy.config.configList.defaultScreen,e=f(e)?2:e-1,d=c.getFolderById(e),h=c.getFolderById(5),k=[],z,q=!1,m=alloy.config.getMustInstallAppList(),y;for(y in m){var n=Number(y);alloy.config.isInSetupAppList(n)||(q=!0,z={t:g.APP,id:n},b.push(n),c.getFileByFile(z)||(k.push(z),c.addFile(z,5,0,!1,!0)))}if(q&&(a.profile("forceInstallApp"),alloy.config.sendSetSetupAppList(),k.length)){var x=h.items.length,F=k.concat();U(function(){E(F,
5,x,M,{fileList:F},!0)})}k=[];if(h.items.length>5)for(z=h.items;z.length>5;)n=z.length-1,k.push(z[n]),c.moveFile(z[n],e,null,5,n,!1,!0);if(k.length&&(a.profile("checkDock"),!q)){var ia=k.concat();U(function(){K(ia,e,0,5,null,W,{fileList:ia},!0)})}k=[];q=c.getFilesByType(g.APP);for(y in b)q[b[y]]||(z={t:g.APP,id:b[y]},k.push(z));if(k.length){a.profile("addMissApp");c.addFiles(k,e,-1,!1,!0);var v=k.concat(),o=d.items.length;U(function(){E(v,e,o,M,{fileList:v},!0)})}var d={},k=!1,j;for(j in q)if((n=
Number(q[j].id))&&a.array.indexOf(b,n)==-1)k=!0,z=q[j],y=c.getFileInfoByFile(z),d[y.parent.id]||(d[y.parent.id]={}),d[y.parent.id][z.id]=z,c.deleteFile(z,null,null,!1,!1,!0);if(k){a.profile("removeSurplusApp");for(var l in d){b=[];j=Number(l);for(var r in d[l])b.push(d[l][r]);U(a.bind(function(a){G(a.fileList,a.folderId,W,null,!0)},c,{fileList:b,folderId:j}))}}X()};this.createRecentContactFolder=function(a){if(!h()){var b=c.getFolderByName("\u5e38\u7528\u8054\u7cfb\u4eba");if(b){if(a.length){var e=
...
c),c++)})},onClearDefaultApp:function(){ba()},onFileMove:function(a){if(a.targetId>=0&&a.targetId<5){if(a.targetId==a.sourceId)var b=Y(a.file.id,a.file.t);else a.sourceId>=0&&a.sourceId<5&&(b=Y(a.file.id,a.file.t))&&aa(b,a.sourceId,a.sourcePosition),b=z(a.file,p[a.targetId].getIconContainer(),a.targetId);b&&ja(b,a)}else a.sourceId>=0&&a.sourceId<5&&(b=Y(a.file.id,a.file.t))&&aa(b,a.sourceId,a.sourcePosition)},onFileAdd:function(a){var b=a.parent.id;if(b>=0&&b<5){var c={targetId:b,targetPosition:a.position,
sourceId:-1,sourcePosition:-1};(a=z(a.file,p[b].getIconContainer(),b))&&ja(a,c)}},onFileDelete:function(a){var b=a.parent.id;if(b>=0&&b<5){var c=Y(a.file.id,a.file.t);c&&aa(c,b,a.position)}},onFileOperateTimeout:function(){alloy.layout.alert("\u64cd\u4f5c\u8d85\u65f6\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onFileOperateError:function(){alloy.layout.alert("\u64cd\u4f5c\u5931\u8d25\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002 ")},onAddFileFail:function(a){a.retcode==0&&a.result&&a.result.code==30001?
...
var X=function(a){a.stopPropagation();k===g.EDIT?(M(g.NORMAL),alloy.util.report2qqweb("screen | ipad | edited ")):(alloy.layout.showContextMenu({x:a.clientX,y:a.clientY},{items:O}),alloy.util.report2qqweb("add | add | "+alloy.desktopManager.getCurrentDesktopIndex()))},z=function(b,c){var d={parentNode:c},f;if(b.t==C.APP){var g=b.id;f=alloy.appconfig.getAppConfig(g);if(!f)return a.profile('createFileIcon. id="'+g+'" appConfig is null',"DesktopManager "),alloy.fileSystem.deleteFile(b,null,null,null,!1),null;
...
e);if(!u[e]){u[e]=!0;var g=p[e].getIconContainer();c.hide(g);var k=new a.fx.Animation({element:g,property:"opacity ",from:0,to:1,unit:!1,duration:2E3,fps:30,transition:d.sinusoidal.easeOut});o[e]=new a.Chunk(b,function(a){a&&(a=z(a,g,e))&&m[e].push(a.getId())},this,!1,function(){ea();setTimeout(function(){a.browser.ie==7||a.browser.ie==6?c.show(g):(c.setStyle(g,"opacity ",0),c.show(g),k.start())},500);f&&f()})}},aa=function(a,b,c){m[b].splice(c,1);a=e[a.getId()];delete e[a.getId()];a.destroy();Z(b,
...
Jx().$package("alloy.portal ",function(a){var c=this,b=a.dom,d=a.event,g=a.http,j=a.cookie,l,p=!1,t,r=alloy.CONST.LOGIN_LEVEL_NONE,u=0,w,s=1,n,f,h=!1,m=!1,o=0,D=0,e,k=!1,B="",x,A,y="",v="",q=null,C=0,E=!1,G,K,P,J,N=!1,I,V,O=[],H=[],T=0,Q="socket ",F,L=0,S={},W,M=null,U=!0;alloy.system=c;var X=[],z=["pgv_info ","ptisp ","uin ","skey ","ptwebqq "];c.saveAndDelLockCookie=function(){for(var a in z)X.push({name:z[a],value:j.get(z[a])}),j.remove(z[a],alloy.CONST.MAIN_DOMAIN)};c.revertLockCookie=function(){for(var a=
...
function(a) {
    ...
    this.showLoginBox = this.showLoginWindow = function(b, e, d, g) {
        ...
        e ? (b.src = "http://ui.ptlogin2.qq.com/cgi-bin/login?target=self&style=5&mibao_css=m_webqq&appid=1003903&enable_qlogin=0&no_verifyimg=1&s_url=" + k + "&f_url=loginerroralert&strong_login=1&login_state=" + d + "&t=" + alloy.CONST.UPDATE_TIME_STAMP, h = '            <div id="login_window_content_area" class="login_content_area"><div class="login_logo_qq"></div>' + h + '<div class="login_window_wrap">            <iframe id="ifram_login"  src="' + b.src + '" scrolling="no" frameborder="no" allowtransparency="true" scrolling="hidden" hidefocus ></iframe>                    </div></div>') : (b.src = "http://ui.ptlogin2.qq.com/cgi-bin/login?target=self&style=5&mibao_css=m_webqq&appid=1003903&enable_qlogin=0&no_verifyimg=1&s_url=" + k + "&f_url=loginerroralert&strong_login=0&login_state=" + d + "&t=" + alloy.CONST.UPDATE_TIME_STAMP, h = '<div id="login_window_content_area" class="login_content_area"><div class="login_logo_webqq"></div>' + h + '<div class="login_window_wrap">            <iframe id="ifram_login"  src="' + b.src + '" scrolling="no" frameborder="no" allowtransparency="true" scrolling="hidden" hidefocus ></iframe>                    </div></div>');
        f = new a.ui.Boxy(b);
...
function(a) {
    ...
    y = {
        ...
        onAlloyJsReady: function() {
            x();
            A();
            d.addObserver(alloy.sound, "SoundMuteChange", y.onSoundSettingChange)
        },
    ...
    this.init = function(e) {
        ...
        d.on(r, "click", y.onToolListClick);
        d.on(h.start, "click", y.stopPropagation);
        d.on(h.start, "click", y.onStartClick);
        b.setStyle(g, "zIndex", alloy.layout.getTopZIndex());
        c.setDockLocation("left");
        d.on(g, "contextmenu", y.onDockContextMenu);
        t.setAttribute("customAcceptDrop", 1);
        d.addObserver(t, "dragmove", y.onQuickListContainerDragMove);
        d.addObserver(t, "drop", y.onQuickListContainerDrop);
        n.addDropTarget({
            el: t,
            level: 1
        });
        ...
        e.appendChild(p);
        e = new a.ui.Drag(g, l);
        d.addObserver(e, "start", y.onDockDragStart);
        d.addObserver(e, "move", y.onDockDragMove);
        d.addObserver(e, "end", y.onDockDragEnd);
        d.addObserver(alloy.rpcService, "SendGetNewAppCountSuccess", y.onGetNewAppCountSuccess);
        d.addObserver(qqweb.portal, "AlloyJsReady", y.onAlloyJsReady);
        d.addObserver(alloy.portal, "portalReady", y.onPortalReady);
        d.addObserver(alloy.storage, "StorageSpaceChanged", y.onStorageSpaceChanged);
        a.profile("Dock CreateFinish");
        d.addObserver(alloy.fileSystem, "FileMove", y.onFileMove);
        d.addObserver(alloy.fileSystem, "FileAdd", y.onFileAdd);
        d.addObserver(alloy.fileSystem, "FileDelete", y.onFileDelete);
        d.addObserver(alloy.appconfig, "ClearDefaultApp", y.onClearDefaultApp);
        d.addObserver(alloy.appconfig, "GetAppConfigComplete", y.onGetAppConfigComplete);
        d.addObserver(alloy.appconfig, "GetDefaultAppConfigComplete", y.onGetAppConfigComplete);
        d.addObserver(alloy.appconfig, "GetAppConfigError", y.onGetAppConfigError);
        d.addObserver(alloy.portal, "UACReady", y.onUACReady);
        d.addObserver(alloy.portal, "DesktopSwitchStatus", y.onDesktopSwitchStatus)
    }
});
...
function(a) {
    ...
    B = function(b, e) {
        ...
        for (h in b) {
            ...
            f.push(j);
            d.addObserver(j, "iconclick", k)
        }
        return f
    },
    x = function(b, c) {
        var e, d = alloy.fileSystem.FILE_TYPE;
        if (b.t == d.APP) e = alloy.appconfig.getAppConfig(b.id),
...
function(a) {
    ...
    y = function(c) {
        ...
        this.setCurrent = function(a) {
            ...
            b.addClass(y, "taskCurrent")
        };
        this.setNotCurrent = function(a) {
            if (!y) return ! 1; (a = this.getItem(a)) && a.setNotCurrent();
            b.removeClass(y, "taskCurrent")
        };
        this.jumpUp = function(a) {
            b.addClass(y, "taskJumpUp"); (a = this.getItem(a)) && a.jumpUp()
        };
        this.jumpDown = function() {
            b.removeClass(y, "taskJumpUp")
        };
        this.winMin = function() {
    ...
    C = {
        onNewTaskItem: function(b) {
            ...
            e = o(c);
            if (a.isUndefined(e) || !e) e = new y(b),
            e.init(),
            m[c] = e;
            e.addItem({
                id: b.id,
...
function(a) {
    ...
    this.init = function() {
        ...
        l = new e;
        p = new B;
        d.addObserver(alloy.portal, "UACReady", y);
