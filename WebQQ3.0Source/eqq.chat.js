(function() {
    WebqCore.register("EQQ.View.ChatBox",
    function(e) {
        var d = this,
        b = e.dom,
        c = e.event,
        ...
        S = function(a) {
            ...
            d.chatLogOptionPanel.hide();
            a = d.getCurrent();
            a.chatBoxType == "group" ? c.notifyObservers(d, "ExportGroupCurrentChatLog", a.uin) : a.chatBoxType == "discu" ? c.notifyObservers(d, "ExportDiscuCurrentChatLog", a.did) : c.notifyObservers(d, "ExportCurrentChatLog", a.uin);
            pgvSendClick({
        ...
        this.setClientType = function(a) {
            ...
            if (c && c.uin == a.uin) {
                var c = b.id("chatBox_clientType_" + a.uin) || {},
                f = b.id("chatBox_clientTypeImg_" + a.uin) || {},
                e = EQQ.hash.clientType[a.clientType || "10000"];
        ...
        this.setChatboxSignature = function(a) {
            ...
            if (c) e.out(a.htmlSignature),
            c.innerHTML = a.htmlSignature,
            c.title = a.signature
        };
        ...
        this.createFacePanel = function() {
            ...
            this.facePanelNotice = function(a, c) {
                var B = c ? 0 : 1;
                if (this.facePanelNotice.timer) clearTimeout(this.facePanelNotice.timer),
            ...
            function(a) {
                ...
                if (a > 0 && a > 256E3) return d.facePanelNotice("\u6587\u4ef6\u5927\u5c0f\u8d85\u8fc7250KB"),
                0;
        ...
        this.createCustomFaceList = function(a) {
            var f = this;
            w = a;
            w.length === 0 ? r.innerHTML = '<div class="noCustomFaceText">\u6682\u65e0\u81ea\u5b9a\u4e49\u8868\u60c5</div><a class="noCustomFaceAddButton"><div class="addCustomFaceIcon"></div>\u7acb\u5373\u6dfb\u52a0</a>': (r.innerHTML = "", e.array.forEach(w, this.addCustomFace), c.on(r, "click",
            function(a) {
                a.preventDefault();
                ...
                if (g) c.notifyObservers(d, "DeleteCustomFace", {
                    ...
                    if (a = d.getCurrent()) a.focusEditor(),
                    a.editor.isEnable() ? a.editor.insertCustomFace(e) : a.editor.insertText(e);
        ...
        this.showFacePanel = function(a) {
            var f = a.xy,
            a = a.showCustom;
            this.facePanel ? c.addObserver(d, "HideFacePanel", e.bind(this.hideFacePanel, this)) : this.createFacePanel();
            if (f) {
        ...
        this.uploadSendFile = function() {
            ...
            g = "",
            g = f.value;
            if (g == "") return d.getCurrent().tips("\u8bf7\u9009\u62e9\u6587\u4ef6!"),
            0;
        ...
        this.uploadOffFile = function() {
            ...
            if (/\.(exe)$/i.test(g)) return a.tips("\u8be5\u7c7b\u578b\u6587\u4ef6\u4e0d\u652f\u6301\u4f20\u9001\uff0c\u8bf7\u91cd\u65b0\u9009\u62e9\uff01"),
            ...
            c.notifyObservers(d, "SendMsgToSelf", {
                ...
                from_uin: 0,
                to: a.uin,
                content: [["uploadingofffile", "\u60a8\u6b63\u5728\u4f20\u8f93\u79bb\u7ebf\u6587\u4ef6\u201c" + g + "\u201d..."]],
                attach: {
        ...
        this.uploadSendPic = function() {
            ...
            if (c.chatBoxType == "single") {
                ...
                g = a.file
            } else g = a.custom_face,
            f = a.custom_face.value,
            a.action = EQQ.CONST.UPLOAD_CUSTOM_FACE_SERVER + "?time=" + (new Date).getTime();
            if (d.getFileSize(g) > 1048576) return d.getCurrent().tips("\u6587\u4ef6\u5927\u5c0f\u8d85\u51fa1M\u9650\u5236!"),
            a.reset(),
            0;
            if (!/\.(jpeg|jpg|gif|bmp|png)$/i.test(f)) return e.out(f),
            d.getCurrent().tips("\u8bf7\u9009\u62e9\u56fe\u7247\u6587\u4ef6!"),
            a.reset(),
            0;
            f = d.geneSendPicId();
            a.fileid.value = f;
        ...
        this.removeLoading = function(a) {
            if (typeof a == "undefined" && a == "") return ! 1; (a = e.dom.id("loading_" + a)) && a.parentNode.removeChild(a)
        };
        ...
        this.createGroupMaskPanelDom = function() {
            ...
            e.array.forEach([this.promptDom, this.noPromptDom, this.maskDom],
            function(a) {
                c.on(a, "click", U)
            })
        };
        ...
        this.exportDiscuChatLog = function(b, c) {
            ...
            if (g) {
                ...
                if (g == "") return alloy.layout.alert("\u672c\u7fa4\u6682\u65e0\u6d88\u606f\u8bb0\u5f55\u3002"),
                !1;
        ...
        this.receiveFile = function(a, c) {
            ...
            if (typeof d == "undefined" || d == null) d = document.createElement("IFRAME"),
            d.id = "f_download",
            d.name = "f_download",
            d.src = alloy.CONST.MAIN_URL + "domain.html",
        ...
        this.removeReceiveFileLink = function(a) {
            ...
            c.on(b.id("agree_" + a), "click",
            function(a) {
                a.preventDefault()
            });
            c.on(b.id("refuse_" + a), "click",
            function(a) {
                a.preventDefault()
            })
        };
        this.receiveOffFile = function(a) {
            ...
            c = b.id("f_download");
            if (typeof c == "undefined" || c == null) c = document.createElement("IFRAME"),
            c.id = "f_download",
            c.name = "f_download",
            c.src = alloy.CONST.MAIN_URL + "domain.html",
        ...
        this.createSendFilePanel = function() {
            var a = d.getCurrent();
            if (!a) return e.out("chatBox is null"),
            !1;
            var f = a.uin;
            l = b.node("div", {
                "class": "sendFilePanel"
        ...
        this.hideSendFilePanel = function(a) {
            if (e.isUndefined(a) || !a) for (var b in z) a = z[b],
            a.hide();
            else if (a = z[a]) return a.hide()
        };
        this.setSendFilePanelClass = function(a) {
            if (e.isUndefined(a) || !a) for (var c in z) a = z[c],
            b.addClass(a.container, "sendFilePanelEx");
    ...
    WebqCore.register("EQQ.View.TaskBar",
    function(e) {
        var d = e.dom,
        b = e.event,
        c = this,
        ...
        this.createTaskDom = function(m, p) {
            ...
            if (h = d.id("EQQ_TaskBar_CloseChatboxButton_" + m.uin)) b.on(h, "click",
            function(d) {
                d.stopPropagation();
        ...
        this.createGroupTaskDom = function(m, p) {
            ...
            k.innerHTML = h;
            this.EQQ_ChatBuddyList.appendChild(k);
            if (h = d.id("EQQ_TaskBar_CloseChatboxButton_" + m.gid)) b.on(h, "click",
            function(d) {
                d.stopPropagation();
        ...
        this.hideTyping = function(b) {
            k[b] && (clearTimeout(k[b]), k[b] = null); (b = d.id("EQQ_taskBar_typing_" + b)) && d.setStyle(b, "display", "none")
        };
        ...
        this.createDiscuTaskDom = function(k, p) {
            ...
            if (n = d.id("EQQ_TaskBar_CloseChatboxButton_" + k.did)) b.on(n, "click",
            function(d) {
                d.stopPropagation();
        ...
        this.updateDiscuName = function(b) {
            ...
            if (c) c.innerHTML = b.htmlName,
            d.id("BuddyInTaskbar_" + b.did).title = b.titleName
        }
    })
})(); (function() {
    WebqCore.register("EQQ.View.ChatBox",
        ...
        },
        {
            ...
            loadStyle: function() {
                ...
                if (b) {
                    ...
                    this.setStyle("color", b[c++])
                } else this.setStyle("fontFamily", "\u5b8b\u4f53"),
                this.setStyle("fontSize", "10pt"),
    ...
    function(e) {
        ...
        this.init = function() {
            ...
            b.addObserver(alloy.portal, "UserAvatarChanged", e.bind(this.onUserAvatarChanged, this));
            ...
            b.addObserver(EQQ.Model.BuddyList, "SelfInfoChange", e.bind(this.onSelfInfoChange, this));
            ...
            b.addObserver(EQQ.Model.BuddyList, "GetUserInfoSuccess", e.bind(this.onGetUserInfoSuccess, this));
            ...
            b.addObserver(EQQ.Model.BuddyList, "AddBuddy", e.bind(this.onAddANewBuddy, this));
            ...
            b.addObserver(EQQ.Model.BuddyList, "SingleGroupMaskChange", e.bind(this.onSingleGroupMaskChange, this));
            ...
            b.addObserver(EQQ.Model.ChatMsg, "MessageListChange", e.bind(this.onMessageListChange, this));
            ...
            b.addObserver(EQQ.Model.BuddyList, "AddNewDiscuToList", e.bind(this.onAddNewDiscuToList, this));
        ...
        this.onBuddyListChange = function(a) { ! v && !w && (this.updateAllBuddyClassCount(EQQ.Model.BuddyList.getClassList()), this.createBuddyList(a))
        };
        ...
        this.onAddANewBuddy = function(a) {
            ...
            b.getState() != EQQ.hash.onlineStatus.offline && (this.View.addOnlineBuddy(f), this.View.updateOnlineBuddyClass(EQQ.Model.BuddyList.getOnlineBuddy()), this.View.updateBuddyClassOnlineBuddy(c))
        };
        ...
        this.onMessageBoxGroupListChange = function(c) {
            ...
            h = [];
            for (var d = 0; d < c.length; d++) f != c[d].from_uin && EQQ.Model.BuddyList.isGroupPrompt(c[d].from_uin) && h.push(c[d].from_uin),
            EQQ.Model.BuddyList.getSelfState() == "callme" && EQQ.Model.BuddyList.isGroupPrompt(c[d].from_uin) && l(c[d].group_code);
        ...
        this.onMessageBoxDiscuListChange = function(c) {
            ...
            m.length !== 0 && (EQQ.addNeedBeat2("mainPanel"), b.addObserver(EQQ, "NotifyBeat_250", K))
        };
        var L = function(a) {
    ...
    WebqCore.register("EQQ.Presenter.ChatBox",
    function(e) {
        var d = e.event,
        b = e.string,
        c = this;
        ...
        this.init = function() {
            ...
            d.addObserver(EQQ.View.ChatBox, "SetSingleGroupMaskState", A);
        ...
        this.onRemoveBuddy = function(a) { (a = this.View.getChatBox(a.user.uin)) && a.close()
        };
        ...
        this.onCloseWebQQ = function() {
            for (var a = null,
            b = c.View.getChatBoxList(); a = b.pop();) a.close()
        };
        ...
        this.onSendMsg = function(a) {
            if (EQQ.Model.BuddyList.getSelfState() == "offline") return a && a.tips("\u60a8\u5df2\u7ecf\u5904\u4e8e\u79bb\u7ebf\u72b6\u6001\uff0c\u8bf7\u4e0a\u7ebf\u540e\u518d\u5c1d\u8bd5"),
            !1;
            var b = [],
            f = [],
            d = /\[.*?\]/,
            ...
            j = /\[\u53d1\u9001\u56fe\u7247[/\ - a - z0 - 9A - z] {
                ...
                1,
                50
            }\] / , o, l, i = a.editor.getText(), z = EQQ.Model.ChatMsg.getCustomFaceList(), k = EQQ.Model.ChatMsg.getSendPicList(), u = !1, h = []; o = "";
            for (var H = 0,
            m = 0,
            n = [], q = a.chatBoxType.toUpperCase(); f = i.match(d);) if (l = f[0], l.match(g)) f.index && b.push(i.slice(0, f.index)), o = parseInt(l.replace(/\[face|\]/, "")), o < 135 ? b.push(["face", o]) : b.push("[face" + o + "]"), i = i.slice(f.index + l.length);
                ...
                H++;
                if (H > 10) return a.tips("\u56fe\u7247\u6570\u76ee\u8d85\u8fc710\u5f20\u9650\u5236\uff01"),
                !1;
                f.index && b.push(i.slice(0, f.index));
                o = l.replace(/\[\u53d1\u9001\u56fe\u7247|\]/g, "");
                if (o == "loading") return a.tips("\u56fe\u7247\u52a0\u8f7d\u4e2d\uff0c\u8bf7\u7a0d\u5019\uff01"),
                !1;
                m += k[o].filesize;
                if (m > 1258291.2) return a.tips("\u56fe\u7247\u5bb9\u91cf\u8d85\u8fc71.2M\u9650\u5236\uff01"),
                !1;
                b.push(["offpic", o, k[o].filename, k[o].filesize]);
                i = i.slice(f.index + l.length)
            } else l.match(y) ? (u = !0, f.index && b.push(i.slice(0, f.index)), o = l.replace(/\[\u56fe\u7247|\]/g, ""), a.chatBoxType === "single" ? b.push(["cface", o]) : (b.push(["cface", "group", o]), n.push("WEB2QQ.IM." + q + "IMG.PICTURE")), i = i.slice(f.index + l.length)) : (f = f.index + l.length, b.push(i.slice(0, f)), i = i.slice(f)); b.push(i); c._startPgvSendClick(n); h.push("font"); a.editor.isEnable() ? (d = a.editor.getAllStyles(), (j = d[5].match(/^#([0-9a-f]{6})/)) ? j = j[1] : (j = d[5].match(/\d{1,3}/g), j.length == 3 ? (g = parseInt(j[0]).toString(16), e = parseInt(j[1]).toString(16), j = parseInt(j[2]).toString(16), g.length == 1 && (g = "0" + g), e.length == 1 && (e = "0" + e), j.length == 1 && (j = "0" + j), j = g + e + j) : j = "000000"), h.push({
                name: d[0],
                size: d[1].match(/\d+/)[0],
                ...
                style: [0, 0, 0],
                name: "\u5b8b\u4f53"
            }); EQQ.Model.BuddyList.getSelf(); d = EQQ.CONST.WEBQQMSGTIPS;
        ...
        this.onAskVideo = function(a) {
            ...
            a.videoWin || qqweb.util.report2im("mining|invite"),
            c.initVideo(a, b),
            a.setCurrent()
        };
        ...
        this.popVideoWindow = function(a) {
            if ((a = c.View.getChatBox(a)) && a.videoWin) a.getBoxStatus() == "fullscreen" && a.restorefull(),
            a.setWidth(a.option.width),
            a.setHeight(a.option.height),
            a.removeSubordinate(),
            a.videoWin.setZIndexLevel(1),
            a.videoWin.setCurrent()
        };
        this.innerVideoWindow = function(a) {
            if ((a = c.View.getChatBox(a)) && a.videoWin) a.isShow() || a.show(),
            a.videoWin.setZIndexLevel(0),
            a.videoWin.setZIndex(a.getZIndex() + 1),
            a.addSubordinate(a.videoWin, {
                mode: 1,
                subWinWidth: 408,
                isSubWinFloat: !0,
                width: 291,
        ...
        this.closeVideo = function(a) {
            if ((a = c.View.getChatBox(a)) && a.videoWin) a.videoTimeout && clearTimeout(a.videoTimeout),
            this.removeVideo(a)
        };
        ...
        this.onSetSendPicUrlError = function(a) {
            var b = c.getCurrent();
            b && (b.tips("\u7533\u8bf7\u56fe\u7247\u6587\u4ef6\u5730\u5740\u5931\u8d25\uff01"), typeof a.fileid !== "undefined" && a.fileid && EQQ.View.ChatBox.removeLoading(a.fileid))
        };
        var x = function(a) {
            a.clearChatLog();
        ...
        this.chatWithUser = function(a, b) {
            ...
            } else if (d) if (d.type === "buddy" || d.type === "stranger") f = this.addChatBox(d, b),
            c.checkIsOnVideo({
                uin: a
            }),
            f.setCurrent();
        ...
        this.closeByGroup = function(a) {
            if (a = this.getChatBoxByCode(a)) a.close(),
            this.View.removeChatBox(a)
        };
        this.updateGroupTitle = function(a, b) {
            ...
            typeof b.announcement != "undefined" && c.upAnnouncement(b.announcement); (c = this.getChatBoxByCode(a)) && c.upateGroupTitle()
        };
        ...
        this.onChatBoxAdd = function(a) {
            if (a.chatBoxType === "discu") EQQ.Model.ChatMsg.getDiscuMsgHistory(a.did),
            EQQ.Model.BuddyList.getDiscuInfo(a.uin);
            else if (a.chatBoxType === "group") EQQ.Model.ChatMsg.getGroupMsgHistory(a.gid),
            EQQ.Model.BuddyList.getGroupInfo(a.code),
            k = !0;
            else {
        ...
        i = function(a) {
            if (EQQ.Model.BuddyList.getSelf().state == "offline") return a && a.tips("\u60a8\u5df2\u7ecf\u5904\u4e8e\u79bb\u7ebf\u72b6\u6001\uff0c\u8bf7\u4e0a\u7ebf\u540e\u518d\u5c1d\u8bd5"),
            !1;
        ...
        O = function(a) {
            ...
            var b = [["refuseofffile", "\u60a8\u62d2\u7edd\u63a5\u6536\u201c" + a.name + "\u201d\uff0c\u6587\u4ef6\u4f20\u8f93\u5931\u8d25\u3002"]],
            f = {
                type: "refuseofffile",
                name: a.name,
                from_uin: a.from_uin,
        ...
        N = function(a) {
            c.View.removeReceiveFileLink(a.fileid);
            c.View.nextOffFile(a.fileid);
            var b = [["nextofffile", '\u60a8\u53d6\u6d88\u4e86\u79bb\u7ebf\u6587\u4ef6"' + a.name + '"\u7684\u63a5\u6536\uff0c\u6211\u4eec\u5c06\u5728\u60a8\u4e0b\u6b21\u767b\u5f55\u540e\u8fdb\u884c\u63d0\u9192\u3002']],
            f = {
                type: "nextofffile",
                name: a.name,
                from_uin: a.from_uin,
        ...
        L = function(a) {
            var b = [["canceloffupload", "\u60a8\u7ec8\u6b62\u4e86\u201c" + a.name + "\u201d\u7684\u53d1\u9001\u3002"]],
            f = {
        ...
        this.chatWithDiscu = function(a) {
            ...
            b.scrollToBottom();
                ...
                a = EQQ.Model.BuddyList.getDiscuById(a);
                if (e.isUndefined(a) || !a) return e.error("option.userOrGroup is null"),
                !1;
        ...
        this.closeByDiscu = function(a) {
            if (a = this.getChatBoxByDid(a)) a.close(),
            this.View.removeChatBox(a)
        };
        this.addDiscuChatBox = function(a) {
        ...
        this.showTyping = function(a) { (a = c.getChatBox(a)) && a.showTyping()
        };
        this.hideTyping = function(a) { (a = c.getChatBox(a)) && a.hideTyping()
        };
        var Q = function(a) {
    ...
    WebqCore.register("EQQ.Presenter.TaskBar",
    function(e) {
        var d = this,
        b = e.event,
        c = e.dom,
        ...
        m = [],
        r = {},
        I = function(b) { (b = EQQ.Presenter.ChatBox.getChatBox(b)) && b.close()
        },
        v = function() {
            d.setMode("free")
        },
        ...
        x = {
            ...
            onChatBoxClose: function(b) { (b = d.getTask(b)) && b.close()
            },
            onChatBoxSetCurrent: function(b) { (b = d.getTask(b)) && b.setCurrent()
            },
            onChatBoxSetNotCurrent: function(b) { (b = d.getTask(b)) && b.setNotCurrent()
            },
            onChatBoxMin: function(b) { (b = d.getTask(b)) && b.setNotCurrent()
            }
        },
        s = new e.Class({
            init: function(c, i, k) {
        ...
        this.onMessageBoxUserListChange = function(c) {
            ...
            if (i.state != "callme") for (i = 0; i < c.length; i++) this.getTask(c[i].from_uin) && (k == c[i].from_uin ? (e.out("\u5f53\u524d\u7a97\u53e3\u7684\u5219\u76f4\u63a5\u8bbe\u7f6e\u4e3a\u5df2\u8bfb"), EQQ.Model.ChatMsg.removeMessageBoxUserList(k), e.out("\u8bbe\u7f6e\u4e3a\u5df2\u8bfbfinish")) : d.addJumpUserList("user", c[i]));
        ...
        this.addJumpUserList = function(b, c) {
            d.View.resetJumpCount(c.from_uin, c.time);
        ...
        this.setMode = function(b) {
            ...
            b = this.getCurrentTaskUin(); (b = d.getTask(b)) && b.setCurrent()
        };
        var t = function() {
            n = [];
            n = n.concat(p, k, h);
            n.length > 0 ? d.View.jumpAvatar(n) : (b.removeObserver(EQQ, "NotifyBeat_250", t), EQQ.removeNeedBeat2("taskBar"))
        };
        ...
        this.onMessageBoxDiscuListChange = function(c) {
            ...
            for (var m = 0; m < c.length; m++) {
                var n = c[m];
                this.getTask(n.did) && (k == n.did ? (e.out("\u5f53\u524d\u7a97\u53e3\u7684\u5219\u76f4\u63a5\u8bbe\u7f6e\u4e3a\u5df2\u8bfb"), EQQ.Model.ChatMsg.removeMessageBoxDiscuList(k), e.out("\u8bbe\u7f6e\u4e3a\u5df2\u8bfbfinish")) : d.addJumpUserList("discu", n))
            }
    ...
    WebqCore.register("EQQ.businessClass",
    function(e) {
        ...
        p = function(a) {
            ...
            if (a) {
                ...
                if (g) g.currentId = f,
                c.notifyObservers(d, "StartChat", a)
            }
            a = d.getCurrent();
        ...
        t = function(a, b) {
            return function(c) {
                ...
                if (d && d != "###" && d.indexOf("###") == -1) {
                    ...
                    var h = this;
                    k ? alloy.rpcService.sendGetFriendUin2(k, 4,
                    function(k) {
                        l = k.result.account;
        ...
        },
        {
            ...
            initFrame: function() {
                ...
                j = {
                    ...
                    onChatBoxKeyDown: function(b) {
                        ...
                        d.getSendMsgKey() ? !b.ctrlKey && !b.shiftKey ? a.checkInput() && c.notifyObservers(d, "SendMsg", a) : b.ctrlKey && a.editor.newline() : b.ctrlKey && !b.shiftKey ? a.checkInput() && c.notifyObservers(d, "SendMsg", a) : a.editor.newline();
                        else if ((b.keyCode === 83 || b.type === "keypress" && b.charCode === 115) && b.altKey && !b.ctrlKey) b.stopPropagation(),
                        b.preventDefault(),
                        a.checkInput() && (c.notifyObservers(d, "SendMsg", a), alloy.util.report2qqweb("hotkey|sendmsg|alts"))
                    },
                    ...
                    onShow: function() {
                        ...
                        c.notifyObservers(d, "ChatBoxShow", a); (e.browser.chrome > 0 || e.browser.ie > 7) && a.scrollToBottom()
                    },
                    onMin: function() {
                    ...
                    onRestore: function() {
                        var b = d.getMode();
                        if (b === "adsorb") a.setWidth(a._adsorbWidth),
                        this.subMode == 1 ? a.setHeight(a._restoreHeight) : a.setHeight(a._adsorbHeight),
                        a.autoAlign();
                        else if (b === "free") {
                            a.setXY(a._x, a._y);
                        ...
                        d.hideFacePanel();
                        b = a.getBoxStatus(); (b == "fullscreen" || b == "max") && c.notifyObservers(a, "resize", b)
                    },
                    ...
                    onChatBoxResize: function() {
                        ...
                        if (c.bottomHeight && d < 130 + c.bottomHeight) b.setStyle(a._inputBox, "height", c._init_bottomHeight + "px"),
                        b.setStyle(a._chatBox_toolBar_top, "bottom", c._init_toolBar_top_bottom + "px"),
                        b.setStyle(a._chatBox_toolBar, "bottom", c._init_toolBar_bottom + "px"),
                        b.setStyle(a._chatBox_chatBoard, "bottom", c._init_charBoard_bottom + "px"),
                        c.toolBar_top_bottom = c._init_toolBar_top_bottom,
                        c.toolBar_bottom = c._init_toolBar_bottom,
                    ...
                    onChatMsgScrollToTop: function() {
                        if (this.scrollTop <= 0 && a._isOverRemainCount) a._moreMsgBtn.innerHTML = a.chatBoxType == "group" && a._viewMoreClickCount < 3 ? "\u70b9\u51fb\u67e5\u770b\u524d3\u6761\u8bb0\u5f55": "\u67e5\u770b\u66f4\u591a",
                        b.show(a._moreMsgTip),
                        setTimeout(function() {
                ...
                c.on(this._chatBox_chatBoard, "mousedown", e.bind(this.stopPropagationAndSetCurrentWithoutFocus, this));
            ...
            initSpeech: function() {
                ...
                this._chatBox_speechButton && (b.show(this._chatBox_speechButton), c.on(this._chatBox_speechButton, "webkitspeechchange",
                function() {
                    a.focusEditor();
            ...
            createToolBarEvent: function() {
                ...
                f = {
                    onFontButtonClick: function() {
                        ...
                        } else d = parseInt(b.getStyle(a._chatBox_chatBoard, "bottom")),
                        d += 28,
                        b.setStyle(a._chatBox_chatBoard, "bottom", d + "px"),
                        a._isShowFontBar = !0,
                        f.toolBar_top_bottom && (b.setStyle(a._fontToolBar, "bottom", f.toolBar_top_bottom + 3 + "px"), c.notifyObservers(a, "resize")),
                        b.show(a._fontToolBar);
                    ...
                    onSendPicButtonClick: function(b) {
                        b.stopPropagation();
                        c.notifyObservers(d, "SendPicButtonClick", a);
                    ...
                    onGroupChatLogMoreLog: function(g) {
                        ...
                        g.preventDefault();
                        g.stopPropagation();
                        if (j == "" || a._viewMoreClickCount > 3) return f.onGroupChatLogButtonClick(g),
                        !1;
                    ...
                    onDragInnerTab: function(f) {
                        ...
                        var l = function(f) {
                            ...
                            if (Math.abs(g) > 3) {
                                ...
                                if (l >= 80 && k >= 45) c.notifyObservers(a, "resize"),
                                b.setStyle(a._inputBox, "height", k + "px"),
                                b.setStyle(a._chatBox_toolBar_top, "bottom", i + "px"),
                                b.setStyle(a._chatBox_toolBar, "bottom", h + "px"),
                                b.setStyle(a._chatBox_chatBoard, "bottom", g + "px"),
                                a._isShowFontBar && (b.setStyle(a._chatBox_chatBoard, "bottom", g - 28 + "px"), b.setStyle(a._fontToolBar, "bottom", i + 3 + "px")),
                                d.topHeight = l,
                                d.bottomHeight = k,
                                d.toolBar_top_bottom = i,
                                d.toolBar_bottom = h,
                                d.charBoard_bottom = g;
                                e = f
                            }
                        },
                        k = function() {
                ...
                c.on(this._chatLogButton, "click", f.onChatLogButtonClick);
                c.on(this._moreMsgBtn, "click", e.bind(E, this, this.uin));
                c.on(this._fileButton, "click",
                function(f) {
                    f.preventDefault();
                    f.stopPropagation();
            ...
            createFontToolBarEvent: function() {
                ...
                f = {
                    onFontFamilyButtonChange: function() {
                        a.editor.setStyle("fontFamily", this.value, !0)
                    },
            ...
            initSideBar: function() {
                if (this.option.hasSideBar) this._chatBox_sideBar = b.id("chatBox_sideBar_" + this.uin),
                this._chatBox_sideBar2 = b.id("chatBox_sideBar2_" + this.uin),
                this.createSideBarDom(),
                this.createSideBarEvent()
            },
            ...
            createSideBarEvent: function() {
                var a = this;
                c.on(this._chatBox_sideBar2, "click",
                function() {
                    a._isExpandSidebar ? (a._isExpandSidebar = !1, a.setSideBarCollapse(), a.onSideBarCollapse(), alloy.util.report2qqweb("groupmask|sidebar|hide")) : (a._isExpandSidebar = !0, a.setSideBarExpand(), a.onSideBarExpand(), alloy.util.report2qqweb("groupmask|sidebar|show"))
                })
            },
            ...
            setFreeMode: function() {
                ...
                if (a !== "max" && (a === "restore" || a === "min")) {
                    if (!this._freeX) this._freeX = this._x,
                    this._freeY = this._y;
            ...
            setAdsorbMode: function() {
                ...
                if (a !== "max" && (a === "restore" || a === "min")) {
                    ...
                    if (!e.isUndefined(this._adsorbHeight) || !e.isUndefined(this._adsorbHeight)) this.setWidth(this._adsorbWidth),
                    this.subMode != 1 && this.setHeight(this._adsorbHeight);
                    this.resize();
                    this.autoAlign()
                }
            },
            ...
            checkInput: function() {
                ...
                if (b == 0 || a == "\n") return this.tips("\u63d0\u793a\uff1a\u6d88\u606f\u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a\uff0c\u8bf7\u8f93\u5165\u5185\u5bb9"),
                !1;
                else if (b > 15E3) return this.appendErrorMsg("\u53d1\u9001\u6d88\u606f\u5185\u5bb9\u8d85\u957f\uff0c\u8bf7\u5206\u6761\u53d1\u9001\u3002"),
                !1;
                a = (new Date).getTime();
                if (this._lastTime && a - this._lastTime < 1E3) return this.tips("\u63d0\u793a\uff1a\u60a8\u53d1\u9001\u6d88\u606f\u7684\u9891\u7387\u8fc7\u5feb\uff0c\u8bf7\u7a0d\u540e\u53d1\u9001"),
                !1;
                this._lastTime = a;
                this.closeTips();
                return ! 0
            ...
            closeTips: function() {
                if (this._isShowTips) this._timer && clearTimeout(this._timer),
                this._isShowTips = !1,
                e.browser.ie && e.browser.ie < 8 ? (e.out("inputAndTipsHeight2: " + i.inputAndTipsHeight), c.notifyObservers(this, "resize")) : b.setStyle(this._chatBox_msgList, "bottom", "0px"),
                b.hide(this._yellowTipsBar)
            },
            tips: function(a) {
            ...
            appendMsg: function(a) {
                ...
                for (var g = [], j = 0; j < a.length; j++) {
                    ...
                    if (l.from_uin == 0) {
                        ...
                        if (!l.sender) l.sender = {},
                        l.sender.uin = h,
                        l.sender.htmlShowName = h,
                        l.sender.titleAllName = h,
                        e.out("\u544a\u8b66\uff1a\u600e\u4e48\u8fd8\u62ff\u4e0d\u5230\u9700\u8981\u7684\u6570\u636e\uff1f");
                        ...
                        b.setStyle(p, "width", "42px"),
                        b.setStyle(p, "height", "42px"),
            ...
            setWarning: function(a, b, c, d) {
                ...
                case "0":
                    pgvSendClick({
                        hottag:
                        "web2qq.groupmask.toolbar.msgsetting.withalerts"
                    });
                    break;
                case "1":
                    ...
                    break;
                case "2":
                    b == "0" ? l = '<span class="warnning_yellow">&nbsp;</span>\u60a8\u5f00\u542f\u4e86\u5c4f\u853d\u6d88\u606f(\u5b8c\u5168\u963b\u6b62' + e + "\u6d88\u606f)\u529f\u80fd\uff0c\u8be5\u63d0\u793a\u4ec5\u672c\u4eba\u53ef\u89c1\u3002": b == "1" && (l = '<span class="warnning_yellow">&nbsp;</span>\u60a8\u5207\u6362\u5230\u5c4f\u853d\u6d88\u606f(\u5b8c\u5168\u963b\u6b62' + e + "\u6d88\u606f)\u529f\u80fd\uff0c\u8be5\u63d0\u793a\u4ec5\u672c\u4eba\u53ef\u89c1\u3002"),
                    this.addWarning(l),
                    pgvSendClick({
            ...
            parseAttach: function(a, f) {
                ...
                if (f.type !== "sendfile") if (f.isread === !1) {
                    ...
                    if (j = b.id("refuse_" + e)) c.on(j, "click",
                    function(a) {
                        a.preventDefault();
                    ...
                    e = a + "_" + f.msg_id;
                    if (j = b.id("agree_" + e)) c.on(j, "click",
                    function(a) {
                        a.preventDefault();
                        qqweb.portal.recoverCookie();
                        f.fileid = e;
                    ...
                    if (j = b.id("next_" + e)) c.on(j, "click",
                    function(a) {
                        a.preventDefault();
                        f.fileid = e;
            ...
            setMoreMsgList: function(a) {
                if (a.retcode != 0) return e.error("\u62c9\u53d6\u66f4\u591a\u8bb0\u5f55\u5931\u8d25:retcode:" + a.retcode),
                !1;
                var d = this.group,
                g = [],
                j;
                ...
                b.setStyle(i, "width", "42px"),
                b.setStyle(i, "height", "42px"),
            ...
            shake: function() {
                ...
                if (a._isSaking) return ! 1;
                    ...
                    if (!a.shakeBeater) {
                        ...
                        d = 0,
                        j;
                        c.addObserver(b, "beater",
                        function() {
                            a.setX(j + Math.sin(d / 180 * Math.PI) * 3); (d += 60) > 1800 && b.end()
                        });
                        c.addObserver(b, "start",
                        function() {
                            d = 0;
                            j = a.getX();
                            a.getY();
        ...
        },
        {
            ...
            initFrame: function() {
                ...
                c.addObserver(this.editor, "Typing",
                function(b) {
                    a.onTyping(b)
                });
            ...
            showTyping: function() {
                var a = this;
                if (this.typing_show) clearTimeout(this.typing_show),
                this.typing_show = null;
                var c = b.id("chatBox_typing_" + this.uin),
                d = b.id("typingInChatbox_" + this.uin);
                if (c && d) b.setStyle(c, "display", "inline"),
                b.show(d),
                this.typing_show = setTimeout(function() {
            ...
            close: function() {
                var a = this;
                this.videoWin ? alloy.layout.confirm("\u5173\u95ed\u89c6\u9891\u7a97\u53e3\u5c06\u4f1a\u4e2d\u6b62\u89c6\u9891\u901a\u8bdd\uff0c\u662f\u5426\u5173\u95ed\uff1f",
                function() {
        ...
        },
        {
            ...
            bindGroupTitleBarDom: function() {
                ...
                c.on(a.announcement, "mousedown", e.bind(this.stopPropagationAndSetCurrentWithoutFocus, this));
            ...
            onListScroll: function() {
                if (this.onListScrollTimer) window.clearTimeout(this.onListScrollTimer),
                this.onListScrollTimer = null;
            ...
            createMembersDom: function(a) {
                var b = this;
                e.timedChunk(a, this.addMember, this, !1,
                function() {
                    b.groupMemberReady()
                })
            },
            ...
            updateMemberState: function(a) {
                if (a.length > 0) {
                    for (var c = {},
                    d = 0,
                    e = this.group.members,
                    d = 0; d < a.length; d++) if (b.id("chatBox_groupMember_buddy_" + a[d].uin)) {
        ...
        },
        {
            ...
            addMember: function(a) {
                ...
                if (this[e]) this[e].appendChild(d),
                b.show(this[e]),
                a.status != "offline" && this._discuOnlineMemberCount++,
                c.on(d, "mouseover", k),
                c.on(d, "mouseout", h),
                b.id("chatBox_discu_" + this.discu.did + "_Member_avatar_" + a.uin).src = EQQ.getUserAvatar(a.uin)
            },
            createMembersDom: function() {
                var a = this;
                e.timedChunk(this.discu.members, this.addMember, this, !1,
                function() {
                    a.discuMemberReady()
                })
            },
            ...
            onQuitDiscu: function(a) {
                a.preventDefault();
                var b = this.uin;
                qqweb.layout.confirm("\u60a8\u771f\u7684\u8981\u9000\u51fa\u8ba8\u8bba\u7ec4\u5417?",
                function() {
        ...
        },
        {
            ...
            setLiteTitleBar: function() {
                ...
                this.setTitleBarName(b);
                a.currentId ? isNaN(a.currentId) ? (a = EQQ.Model.BuddyList.getDiscuById(a.currentId), b = '<div class="chatBox_liteInfoArea">\u4e34\u65f6\u4f1a\u8bdd - \u6765\u81ea\u8ba8\u8bba\u7ec4:' + (a ? a.htmlName: "") + "</div>") : b = '<div class="chatBox_liteInfoArea">\u4e34\u65f6\u4f1a\u8bdd - \u6765\u81ea\u7fa4:' + EQQ.Model.BuddyList.getGroupByGid(a.currentId).htmlShowName + "</div>": b = '<div class="chatBox_liteInfoArea">\u4e34\u65f6\u4f1a\u8bdd</div>';
                this.setTitleBarInfo(b)
            },
