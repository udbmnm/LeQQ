Jx().$package(alloy.app["app" + alloy.config.__eqqid] = alloy.app.eqq = new alloy.businessClass.App(alloy.portal.getAllConfig(alloy.config.__eqqid)),
function(a) {
    var b = a.dom,
    c = a.event,
    e = this,
    ...
    var g = {
        ...
        onSelfInfoReady: function(a) {
            if (e.isRunning() && a) {
                ...
                d = b.id("accountNick"),
                g = b.id("loginAccount");
                if (c && d && g) c.src = alloy.util.getUserAvatar(a.uin, 1) + "&t=" + (new Date).getTime(),
                d.innerHTML = a.htmlNick,
                d.setAttribute("title", a.nick),
                g.innerHTML = "(" + a.uiuin + ")"
            }
        },
        onClose: function() {
            alloy.portal.setTryLoginState(null);
            typeof EQQ != "undefined" && EQQ.getIsLogin() ? (WebqCore.api.log("eqq-close"), alloy.util.report2im("qqpanel|exitqq"), i ? (i.setWindowCentered(), i.setCurrent()) : i = alloy.layout.confirm("\u60a8\u786e\u8ba4\u8981\u5173\u95ed QQ \u5417\uff1f",
            function() {
                EQQ.setIsLogin(!1);
    ...
    r = function() {
        ...
        if (b) EQQ.View.MainPanel.flex = null,
        b.document.write(""),
        document.getElementById("iframe_fflist").src = alloy.CONST.MAIN_URL + "domain.html";
...
WebqCore = {
    ...
    linkNameSpace: function(a, b) {
        var c, e, i = a.split("."),
        k = window;
        for (c = 0; c < i.length - 1; c += 1) e = i[c],
        k[e] = k[e] || {},
        k = k[i[c]];
        k[i[c]] = b
    },
...
WebqCore.api = {
    ...
    require: {
        ...
        updateGroupTitle: [!0, "eqq.chat.js", "unlock",
        function() {},
        function() {}],
        ...
        setSendKey: [!1, "eqq.chat.js", "unlock",
        function() {},
        function() {}]
    },
    ...
    call: function(a) {
        this.ifDataReady.get() ? this.require[a[0]][0] ? this.__api[a[0]].apply({},
        a[1]) : (this.module_queue[a[0]] = this.module_queue[a[0]] || [], this.module_queue[a[0]].push(a), this.loadJs(a[0])) : (this.queue = this.queue || [], this.queue.push(a))
    },
    makeCall: function(a) {
