Jx().$package(alloy.app.bubbleTip = new alloy.businessClass.App(alloy.portal.getSystemConfig("bubbleTip")),
function(d) {
    var h = d.dom,
    b = d.event,
    c = [{
    ...
    function() {
        ...
        f = [];
        for (var a = 0,
        h = c.length; a < h; a++) c[a].id & i && c[a].id & j || f.push(c[a]);
        g = -1;
    ...
    b.addObserver(this, "run",
    function() {})
});
Jx().$package(alloy.app.tips = new alloy.businessClass.App(alloy.portal.getSystemConfig("tips")),
function(d) {
    var h = this,
    b = d.dom,
    c = d.event,
    ...
    x = function(l) {
        ...
        l == "webos" ? (m = d, g.appendChild(m), p = b.id("webos_tipsBox_content"), r = b.id("webos_tipsBox_closeButton"), c.on(r, "click", s.onCloseButtonClick)) : (a.container = d, g.appendChild(d), b.hide(d), a.content = b.id(l + "_tipsBox_content"), a.button = b.id(l + "_tipsBox_closeButton"), c.on(a.button, "click",
        function() {
            b.hide(a.container)
        }))
    },
    ...
    s = {
        onRunFirst: function() {
            ...
            x("webos_eqq");
            z();
            alloy.portal.getLoginLevel() > 1 ? h.initIsShowTip(alloy.config.configList.isShowTip) : c.addObserver(alloy.portal, "UACReady",
            function() {
