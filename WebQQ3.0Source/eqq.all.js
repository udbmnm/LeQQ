(function() {
    ...
    function(b) {
        ...
        var j = {
            onExit: function() {
                alloy.layout.confirm("\u60a8\u786e\u8ba4\u8981\u5173\u95ed Q+ Web \u5417\uff1f",
                function() {
                    d.executeExit()
                },
                {
        ...
        M = d.showEQQtips = function(i) {
            if (!d.eqqTips) {
                ...
                p.addObserver(l, "onBubbleOkBtnClick",
                function() {
                    i.callback && i.callback();
                    d.eqqTips = null
                });
                p.addObserver(l, "onBubbleClose",
                function() {
                    d.eqqTips = null
                });
                p.addObserver(l, "onBubbleNextBtnClick",
                function() {
                    e();
                    i.cancle && i.cancle()
                });
        ...
        var i = function(i, e) {
            ...
            case "single":
                ...
                c = !1,
                k = !1; (c = !!B) && (k = B === EQQ.Presenter.ChatBox.getCurrent());
                ...
                B.shake();
                    ...
                    WebqCore.api.call(["chat", ["single", e,
                    function(i) {
            ...
            case "group":
                ...
                k = c = !1; (c = !!B) && (k = B === EQQ.Presenter.ChatBox.getCurrent());
    ...
    function(b) {
        ...
        this.sendPollSuccess = function(a, d) {
            c.pollWatcher.pollStop(); (new Date).getTime();
            g--;
        ...
        this.sendDeleteCustomFace = function(a) {
            ...
            b.http.loadScript(EQQ.CONST.CONN_SERVER_DOMAIN2 + "cgi-bin/webqq_app/", {
                ...
                onSuccess: function() {
                    typeof cface_delete_result !== "undefined" && m.notifyObservers(c, "SendDeleteCustomFaceSuccess", a.callback ||
                    function() {})
                }
            })
        };
    ...
    function(b) {
        ...
        F = new b.Class({
            ...
            updateMemberState: function(i) {
                ...
                e = 0,
                b = {},
                k = [], e = 0; e < a.length; e++) b[a[e].uin] = a[e].stat;
                a = i.length;
                for (e = 0; e < a; e++) {
                    var f = i[e].info,
                    g = f.uin;
        ...
        t = {
            ...
            onGetBuddySignatureSuccess: function(a) {
                ...
                e.length != 0 && e[0].uin == alloy.portal.getUin() && d.setSelfSignature(e[0].lnick); (a = d.getUserByUin(a.arguments.uin)) && a.setSignature(l);
        ...
        this.setGroupInfo = function(a) {
            ...
            for (var g = [], H = !1, j = 0, n = 0; n < m.length; n++) {
                ...
                J = k[s] && k[s].client_type || 1E4; (q != 20 || s === h) && j++;
                for (var K = D,
                w = D,
                r = 0; r < d.length; r++) if (d[r].muin == s) {
                    p = d[r].card;
                    break
                }
        ...
        this.sendGetDiscuInfoSuccess = function(a) {
            ...
            for (g in k) {
                ...
                n.vip = o.vip; (b.isUndefined(n.vip) || n.vip === !1) && j.push(n.uin);
    ...
    function(b) {
        ...
        this.receiveStrangerMsg = function(a) {
            ...
            g ? m() : alloy.rpcService.sendGetUserInfo_with_code(f, "", "",
            function(a) {
        ...
        this.receiveGroupBuddyMsg = function(a) {
            ...
            m ? j() : alloy.rpcService.sendGetUserInfo_with_code(f, "", "",
            function(a) {
    ...
    d = function(b) {
        ...
        this.removeDiscu = function(b) {
            ...
            g.removeChild(b); (g = c.id("EQQ_discuListInner")) && g.innerHTML == "" && this.showCreatePanel()
        };
    ...
    c = function(c) {
        ...
        },
        {
            ...
            onClick: function(a, c, b) {
                ...
                }), qqweb.util.report2qqweb("contextmenu|group|qun")) : qqweb.rpcService.sendGetFriendUin2(a, 4,
                function(a) {
        ...
        this.setUserMarkName = function(a) {
            ...
            f = alloy.layout.confirm('<div style="text-align: left;margin-top: 15px;margin-left: 20px;">\u8bf7\u8f93\u5165\u5907\u6ce8\u59d3\u540d\uff1a\t\t\t\t\t\t\t\t</div><div style="text-align: left;margin-left: 20px;"><input style="width:318px;margin-top: 5px;                                height: 20px;text-align: left;float: left;" \t\t\t\t\t\t\t\tclass="confirm_markname" type="text" value="' + (b && b.markName || "") + '" /></div>',
            function() {
        ...
        this.init = function() {
            ...
            g.on(this.EQQ_createGroupButton, "click",
            function() {
                pgvSendClick({
            ...
            g.on(this.EQQ_groupTabGroup, "click",
            function() {
            ...
            g.on(this.EQQ_groupTabDiscu, "click",
            function() {
            ...
            g.on(this.EQQ_buddyManage, "click",
            function(a) {
                a.preventDefault();
                a.stopPropagation();
                pgvSendClick({
            ...
            g.on(this.EQQ_messageManage, "click",
            function(a) {
                a.preventDefault();
                a.stopPropagation();
                pgvSendClick({
            ...
            this.mainTab.init();
            g.addObserver(this.mainTab, "show",
            function(a) {
        ...
        this.createGroupMaskPanelDom = function() {
            ...
            c.array.forEach([this.costomDom, this.promptDom, this.noPromptDom, this.maskDom],
            function(a) {
                g.on(a, "click", $a)
            });
        ...
        this.createMiniCardPanelDom = function() {
            ...
            this.miniCardPanel.setQQLevel = function(a) {
                for (var c = a.level,
                b = c.level,
                d = parseInt(b / 64), ea = parseInt(b % 64 / 16), f = parseInt(b % 64 % 16 / 4), e = b % 64 % 16 % 4, l = "", g = 0; g < d; g++) l += '<div class="miniCard_level_div qqLevel_queen"></div>';
        ...
        this.createBuddyList = function(a) {
            c.timedChunk(a, this.addBuddy, this, !1,
            function() {
        ...
        var ga = this.loadBuddyListAvatar = function() {
            for (var b = h.EQQ_buddyListPanel,
            d = parseInt(a.getStyle(b, "height"), 10), b = a.getXY(b)[1], f = 0; f < q.length;) {
                var e = q[f],
                l = e.imgEl,
                g = e.classId,
                i = a.getXY(l)[1] - b;
    ...
    p = Jx().extend(function(d) {
        ...
        this.setUserName = function(a) {
            ...
            h.ifFlexReady ? this.flex.setUserName(a) : recent.type == 2 && (a = this.getNewNode(recent.content, !0), this.EQQ_recentList.insertBefore(a, this.EQQ_recentList.firstChild), g.on(a, "mouseover", onListMouseover), g.on(a, "mouseout", onListMouseout), g.on(a, "click",
            function() {
                h.onDiscuListClick(this)
            }), g.on(a, "contextmenu",
            function(a) {
